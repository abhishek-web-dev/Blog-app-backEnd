...
module.exports.setRouter = function(app) {
	...
	app.get(
		baseUrl + '/view/by/category/:categoryId',
		auth.isAuthenticated,
		blogController.viewByCategory
	);

	/**
	 * @api {get} /api/v1/blogs/view/by/category/:categoryId Get blogs by category
	 * @apiVersion 0.0.1
	 * @apiGroup read
	 *
	 * @apiParam {String} authToken The token for authentication.(Send authToken as query parameter, body parameter or as a header)
	 ...
	 * @apiParam          tags tags of the blog passed as a body parameter
	 *
	 *  @apiSuccessExample {json} Success-Response:
	 *  {
	    "error": false,
